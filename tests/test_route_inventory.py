...
EXPECTED_ROUTES = {
    ...
    ("/account/trading", "account_trading_page", frozenset({"GET"})),
    ("/api/account/state", "account_state", frozenset({"GET"})),
    ("/api/account/trading", "account_trading_api", frozenset({"GET"})),
    ("/api/account/trading", "account_trading_mutate", frozenset({"POST"})),
    ("/api/account/trading/export", "account_trading_export", frozenset({"GET"})),
    ("/api/account/trade-plan/<market>/<symbol>", "account_trade_plan_preview", frozenset({"GET"})),
    ...
    ("/industries/ai-server/relationships", "industry_relationships_page", frozenset({"GET"})),
    ("/api/research/relationships", "industry_relationships_api", frozenset({"GET"})),
    ("/compare", "stock_compare_page", frozenset({"GET"})),
    ("/events", "research_events_page", frozenset({"GET"})),
    ("/perspectives", "perspectives_page", frozenset({"GET"})),
    ("/perspectives/stocks/<market>/<symbol>", "stock_perspectives_page", frozenset({"GET"})),
    ("/perspectives/subjects/<subject_id>", "subject_page", frozenset({"GET"})),
    ("/perspectives/<creator_id>", "creator_page", frozenset({"GET"})),
